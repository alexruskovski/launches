...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>coil</b> with <b>io.coil-kt:coil-compose-base</b> coordinates and
    ...
    /**
     * Dependency provider for <b>coil3</b> with <b>io.coil-kt.coil3:coil-compose</b> coordinates and
     * with version reference <b>coil3</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getCoil3() {
        return create("coil3");
    }
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>android.lifecycle</b>
         */
        public AndroidLifecycleLibraryAccessors getLifecycle() {
            return laccForAndroidLifecycleLibraryAccessors;
        }
    ...
    public static class AndroidLifecycleLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>viddewmodel</b> with <b>androidx.lifecycle:lifecycle-viewmodel-ktx</b> coordinates and
         * with version reference <b>android.livecycle.viewmodel</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getViddewmodel() {
            return create("android.lifecycle.viddewmodel");
        }
    ...
    public static class AndroidxHiltNavigationLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>compose.navigation.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class OkhttpLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>okhttp.interceptor.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class RetrofitLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>retrofit.okhttp.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class RetrofitConverterLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>retrofit.gson.converter.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coil3</b> with value <b>3.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>jetbrainsKotlinJvm</b> with value <b>2.0.20</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.plugin</b>
         */
        public PluginVersionAccessors getPlugin() {
            return vaccForPluginVersionAccessors;
        }
    ...
    public static class AndroidVersionAccessors extends VersionFactory  {
        ...
        private final AndroidLivecycleVersionAccessors vaccForAndroidLivecycleVersionAccessors = new AndroidLivecycleVersionAccessors(providers, config);
        public AndroidVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.android.livecycle</b>
         */
        public AndroidLivecycleVersionAccessors getLivecycle() {
            return vaccForAndroidLivecycleVersionAccessors;
        }

    }

    public static class AndroidLivecycleVersionAccessors extends VersionFactory  {

        public AndroidLivecycleVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>android.livecycle.viewmodel</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getViewmodel() { return getVersion("android.livecycle.viewmodel"); }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.material3</b> with value <b>1.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Group of versions at <b>versions.compose.navigation</b>
         */
    ...
    public static class ComposeMaterialIconsVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.material.icons.extended</b> with value <b>1.7.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ComposeNavigationVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.navigation.version</b> with value <b>2.8.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("compose.navigation.version"); }
    ...
    public static class GoogleVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>google.ksp</b> with value <b>2.0.20-1.0.25</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class HiltVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>hilt.version</b> with value <b>2.51</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class OkhttpVersionAccessors extends VersionFactory  {
        ...
        private final OkhttpInterceptorVersionAccessors vaccForOkhttpInterceptorVersionAccessors = new OkhttpInterceptorVersionAccessors(providers, config);
        public OkhttpVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.okhttp.interceptor</b>
         */
        public OkhttpInterceptorVersionAccessors getInterceptor() {
            return vaccForOkhttpInterceptorVersionAccessors;
        }

    }

    public static class OkhttpInterceptorVersionAccessors extends VersionFactory  {

        public OkhttpInterceptorVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>okhttp.interceptor.version</b> with value <b>4.12.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("okhttp.interceptor.version"); }

    }

    public static class PluginVersionAccessors extends VersionFactory  {

        private final PluginHiltVersionAccessors vaccForPluginHiltVersionAccessors = new PluginHiltVersionAccessors(providers, config);
        public PluginVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.plugin.hilt</b>
         */
        public PluginHiltVersionAccessors getHilt() {
            return vaccForPluginHiltVersionAccessors;
        }

    }

    public static class PluginHiltVersionAccessors extends VersionFactory  {

        public PluginHiltVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>plugin.hilt.version</b> with value <b>2.51</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("plugin.hilt.version"); }

    }

    public static class RetrofitVersionAccessors extends VersionFactory  {

        private final RetrofitGsonVersionAccessors vaccForRetrofitGsonVersionAccessors = new RetrofitGsonVersionAccessors(providers, config);
        private final RetrofitOkhttpVersionAccessors vaccForRetrofitOkhttpVersionAccessors = new RetrofitOkhttpVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.retrofit.gson</b>
         */
        public RetrofitGsonVersionAccessors getGson() {
            return vaccForRetrofitGsonVersionAccessors;
        }

        /**
         * Group of versions at <b>versions.retrofit.okhttp</b>
         */
        public RetrofitOkhttpVersionAccessors getOkhttp() {
            return vaccForRetrofitOkhttpVersionAccessors;
        }

    }

    public static class RetrofitGsonVersionAccessors extends VersionFactory  {

        private final RetrofitGsonConverterVersionAccessors vaccForRetrofitGsonConverterVersionAccessors = new RetrofitGsonConverterVersionAccessors(providers, config);
        public RetrofitGsonVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.retrofit.gson.converter</b>
         */
        public RetrofitGsonConverterVersionAccessors getConverter() {
            return vaccForRetrofitGsonConverterVersionAccessors;
        }

    }

    public static class RetrofitGsonConverterVersionAccessors extends VersionFactory  {

        public RetrofitGsonConverterVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>retrofit.gson.converter.version</b> with value <b>2.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("retrofit.gson.converter.version"); }

    }

    public static class RetrofitOkhttpVersionAccessors extends VersionFactory  {

        public RetrofitOkhttpVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>retrofit.okhttp.version</b> with value <b>4.12.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("retrofit.okhttp.version"); }
    ...
    public static class PluginAccessors extends PluginFactory {
         ...
         * with version reference <b>plugin.hilt.version</b>
         * <p>
    ...
    public static class GooglePluginAccessors extends PluginFactory {
         ...
         * with version reference <b>google.ksp</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
